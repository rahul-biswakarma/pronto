export const templates = [
  ...
  },
  {
    ...
    prompt:
      "Create a vibrant personal website with a dark background, playful 3D character, and colorful accent animations. Include sections for articles, tutorials, courses, and popular content lists. Use approachable language, clear navigation at the top, and category tags for easy browsing.",
  },
  {
    id: "4",
    name: "Max Böck",
  ...
  },
  {
    ...
    prompt:
      "Create a minimalist portfolio website with a dark background, clean typography, and focus on writing, projects, and personal updates. Highlight sections for 'Building', 'Projects', 'Writing', and 'Now' updates. Keep the design simple, with subtle elegance and emphasis on clarity and performance.",
  },
  {
    id: "6",
    name: "Piccalilli",
