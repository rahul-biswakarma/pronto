      ...
      <div className="bg-white rounded-lg">
        ...
        <div className="flex flex-col gap-4 rounded-lg p-4 bg-transparent">
          <p className="text-foreground font-sans text-[16px]">
            We built tools to free us, yet chained ourselves to website builders
            complex ux to build a simple enough profiles. Sharing — that should
            be effortless — now feels like wading through noise.
            <br />
            <br />
            <span>
              So we built <span className="font-italianno text-4xl">feno</span>,
              for people like you.
            </span>
          </p>
          <NewsLetter />
