    ...
    useEffect(() => {
        ...
        const handleMouseOver = (e: MouseEvent) => {
            ...
            if (isOnlyTextElement(target)) {
                target.classList.add("feno-content-editor-highlight");
            }
        };
        ...
        const handleMouseOut = (e: MouseEvent) => {
            const target = e.target as HTMLElement;
            if (isOnlyTextElement(target)) {
                target.classList.remove("feno-content-editor-highlight");
            }
        };
        ...
        const handleClick = (e: MouseEvent) => {
            ...
            if (isOnlyTextElement(target)) {
                ...
                target.classList.add("feno-content-editor-selected");
        ...
        style.textContent = `
            .feno-content-editor-highlight {
				${baseStyle}
            }
			.feno-content-editor-highlight:hover {
				${hoveredStyle}
            }
			.feno-content-editor-selected,
			.feno-content-editor-selected:hover {
				${selectedStyle}
            }
        `;
        ...
        return () => {
            ...
            for (const el of highlightedElements) {
                el.classList.remove("content-editor-highlight");
            }
